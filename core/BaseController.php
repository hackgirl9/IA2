...
class BaseController extends Validations
{
    ...
    {// Método que se encarga de redireccionar a una vista con un array datos.
    ...
    {//Redirecciona a otra controlador y accion
        header('Location:' . BASE_URL . $controller . '/' . $action);
    }

    public function sendAjax($data)
    { // Se encarga de enviar los datos y cabeceras de una peticion AJAX
